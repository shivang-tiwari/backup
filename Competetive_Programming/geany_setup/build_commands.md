...
<ol>
<li>Compile with precompiled header(Ctrl + S): <code>g++ -std=c++17 -include stdc++.h -I /home/shivang/Projects/C++/Headers -Wshadow -Wall -o "%e" "%f" -O2 -Wno-unused-result -D shivang</code> </li>
<li>Compile without precompiled header: <code>g++ -std=c++17 -Wshadow -Wall -o "%e" "%f" -O2 -Wno-unused-result -D shivang</code> </li>
